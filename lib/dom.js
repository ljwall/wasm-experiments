mergeInto(LibraryManager.library, {
	...
	test_cb: function (fp) {
		// The dynCall_* famillly call based on a fucntion pointer. the * should corrispond
		// to the function signiture: first char is return type, second if first argument etc, with
		// 'v': void;
		// 'i': 32-bit integer;
		// 'j': 64-bit integer;
		// 'f': 32-bit float;
		// 'd': 64-bit float
		Module.dynCall_vi(fp, 99);
	},
});
